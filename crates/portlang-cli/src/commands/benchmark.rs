...
/// Run a field multiple times and generate an adaptation report
pub async fn benchmark_command(field_path: PathBuf, runs: usize) -> Result<()> {
    println!("Benchmarking field: {}", field_path.display());
    println!("Runs: {}", runs);
    println!();
    ...
    println!("{}", "=".repeat(60));
    println!("Generating adaptation report...");
    println!("{}", "=".repeat(60));
    println!();
